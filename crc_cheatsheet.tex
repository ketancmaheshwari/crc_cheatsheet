...
\item Material Sci: {\color{red}Material Studio}, Westpa, {\color{red}abaqus}, {\color{red}VASP$^{s}$}
\end{itemize}
...
\#!/bin/bash\\
\#SBATCH -N 1 \hfill\# Ensure that all cores are on one machine\\
\#SBATCH --job-name=abf5 \hfill\#name of job\\
\#SBATCH --output=abf5.out \hfill\#standard output goes to this file\\
\#SBATCH -t 3-00:00 \hfill\# walltime in D-HH:MM\\
...
\#SBATCH --time=02:02:00 \hfill\#walltime in hh:mm:ss\\
